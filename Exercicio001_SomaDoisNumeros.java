...
public class Exercicio001_SomaDoisNumeros {

    public static void main(String[] args){

        /*Faça um programa que solicite dois valores a usuario e retorne a soma*/
        /*Feito por Klaus*/
        ...
        while (true){
            ...
            System.out.println("Para começar digite o primeiro numero da soma:");
            ...
            if (numero1==0 || numero2 ==0){
                ...
                System.out.println("Desaja fazer outra soma? (Sim/Não)");
                resposta = sc.next();
